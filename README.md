...
* **Infrastructure & Networking:** Home lab, on premises local-LLM multi-GPU compute, NAS, IoTs, managed 10GBE network. Remote property Edge Nodes for local automation, sensor aggregation, and independent WAN uplink. 
